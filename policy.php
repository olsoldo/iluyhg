                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-8">
                    <div class="single-footer-widget">
                        ...
                        <ul class="contact-links">
                            <li><i class="pe-7s-home"></i> <span>29682 Hipolito Dale Apt. 767
Sabrynaside, MI 25481</span> </li>
                            <li><i class="pe-7s-mail"></i><a href="#"> braulio56@bednar.com</a></li>
                            <li><i class="pe-7s-call"></i><a href="#">+3378722623684</a></li>
                        </ul>
                    </div>
                </div>
