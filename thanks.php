                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-8">
                    <div class="single-footer-widget">
                        ...
                        <ul class="contact-links">
                            <li><i class="pe-7s-home"></i> <span>194 McKenzie Parkway Suite 747
Wellingtonville, MD 77470-5772</span> </li>
                            <li><i class="pe-7s-mail"></i><a href="#"> edyth25@moore.com</a></li>
                            <li><i class="pe-7s-call"></i><a href="#">+3165616456053</a></li>
                        </ul>
                    </div>
                </div>
