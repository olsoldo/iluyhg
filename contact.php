                ...
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 col-6">
                        <div class="header-logo">
                            <a href="index.php">The Digital Age</a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
                                ...
                                <div class="row">
                                    <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
                                        <div class="input-area mb-4">
                                            <input class="input-item" type="text" placeholder="Name" name="name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12" data-aos="fade-up" data-aos-delay="300">
                                        <div class="input-area mb-4">
                                            <input class="input-item" type="text" placeholder="Phone number"
                                                   name="subject">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12" data-aos="fade-up" data-aos-delay="500">
                                        ...
                                        <button type="submit" id="submit" name="submit"
                                                class="btn btn-secondary button-hover-primary">Send
                                        </button>
                                    </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-8">
                    <div class="single-footer-widget">
                        ...
                        <ul class="contact-links">
                            <li><i class="pe-7s-home"></i> <span>9140 Nick Vista Suite 865
Port Leopoldomouth, FL 38992-5505</span> </li>
                            <li><i class="pe-7s-mail"></i><a href="#"> jbailey@yahoo.com</a></li>
                            <li><i class="pe-7s-call"></i><a href="#">+5514670814060</a></li>
                        </ul>
                    </div>
                </div>
