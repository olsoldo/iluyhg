                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-8">
                    <div class="single-footer-widget">
                        ...
                        <ul class="contact-links">
                            <li><i class="pe-7s-home"></i> <span>188 Wuckert Centers Suite 282
New Okeymouth, AZ 05979-3684</span> </li>
                            <li><i class="pe-7s-mail"></i><a href="#"> laisha52@gmail.com</a></li>
                            <li><i class="pe-7s-call"></i><a href="#">+8309262409863</a></li>
                        </ul>
                    </div>
                </div>
